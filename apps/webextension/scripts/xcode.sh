...
sed -i -e "s/MARKETING_VERSION = 1.0;/MARKETING_VERSION = $version;/g" ./xcode/isTrust/isTrust.xcodeproj/project.pbxproj
sed -i -e "s/PRODUCT_BUNDLE_IDENTIFIER = be.isoc.isTrust;/PRODUCT_BUNDLE_IDENTIFIER = be.isoc.istrust;/g" ./xcode/isTrust/isTrust.xcodeproj/project.pbxproj
sed -i -e "s/PRODUCT_BUNDLE_IDENTIFIER = be.isoc.isTrust.Extension;/PRODUCT_BUNDLE_IDENTIFIER = be.isoc.istrust.extension;/g" ./xcode/isTrust/isTrust.xcodeproj/project.pbxproj
sed -i -e "s/INFOPLIST_KEY_CFBundleDisplayName = isTrust;/INFOPLIST_KEY_CFBundleDisplayName = isTrust;\nINFOPLIST_KEY_LSApplicationCategoryType = \"public.app-category.utilities\";/g" ./xcode/isTrust/isTrust.xcodeproj/project.pbxproj
